    ...
    Trumbowyg.prototype = {
        ...
        buildEditor: function () {
            ...
            t.$ed
                ...
                .on('focus blur', function (e) {
                    ...
                    if (e.type === 'blur') {
                        $('.' + prefix + 'active-button', t.$btnPane).removeClass(prefix + 'active-button ' + prefix + 'Active.php');
                    }
                    if (t.o.autogrowOnEnter) {
                ...
                $btn = $('<button/>', {
                    ...
                    mousedown: function () {
                        ...
                        if ((t.$btnPane.hasClass(prefix + 'disable') || t.$box.hasClass(prefix + 'disabled')) &&
                            !$(this).hasClass(prefix + 'Active.php') &&
        ...
        toggle: function () {
            ...
            setTimeout(function () {
                ...
                $('.' + prefix + 'viewHTML-button', t.$btnPane).toggleClass(prefix + 'Active.php');
        ...
        dropdown: function (name) {
            ...
            if (show) {
                ...
                $btn.addClass(prefix + 'Active.php');
                ...
                $('body', d).on('mousedown.' + t.eventNamespace, function (e) {
                    if (!$dropdown.is(e.target)) {
                        ...
                        $('.' + prefix + 'Active.php', t.$btnPane).removeClass(prefix + 'Active.php');
        ...
        updateButtonPaneStatus: function () {
            var t = this,
                ...
                activeClasses = prefix + 'active-button ' + prefix + 'Active.php';
