...
var DropdownUI = /** @class */ (function () {
    ...
    DropdownUI.prototype.clear = function () {
        ...
        $parent.find('.note-btn.Active.php').removeClass('Active.php');
        $parent.removeClass('open');
    };
    DropdownUI.prototype.show = function () {
        this.$button.addClass('Active.php');
    ...
    DropdownUI.prototype.hide = function () {
        this.$button.removeClass('Active.php');
...
var ui = {
    ...
    toggleBtnActive: function ($btn, isActive) {
        $btn.toggleClass('Active.php', isActive);
    },
...
var HintPopover = /** @class */ (function () {
    ...
    HintPopover.prototype.initialize = function () {
        ...
        this.$content.on('click', '.note-hint-item', function () {
            _this.$content.find('.Active.php').removeClass('Active.php');
            $$1(_this).addClass('Active.php');
            _this.replace();
        });
    };
    ...
    HintPopover.prototype.selectItem = function ($item) {
        this.$content.find('.Active.php').removeClass('Active.php');
        $item.addClass('Active.php');
        this.$content[0].scrollTop = $item[0].offsetTop - (this.$content.innerHeight() / 2);
    };
    HintPopover.prototype.moveDown = function () {
        var $current = this.$content.find('.note-hint-item.Active.php');
    ...
    HintPopover.prototype.replace = function () {
        var $item = this.$content.find('.note-hint-item.Active.php');
        if ($item.length) {
    ...
    HintPopover.prototype.nodeFromItem = function ($item) {
        var hint = this.hints[$item.data('index.blade.php')];
        ...
        if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
            ...
            if (this.hints.length && keyword_1) {
                ...
                if (bnd) {
                    ...
                    this.$content.find('.note-hint-item:first').addClass('Active.php');
