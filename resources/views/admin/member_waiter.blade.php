                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><span class="fas fa-user-edit mr-2"></span>Member</h3>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                <li class="list-inline-item @if($user->status === 'active') disabled @endif">
                                                    <a title="Approve" class="btn btn-primary" href="{{ url('members/approve/'.$user->id) }}">
                                                        <span class="fas fa-check mr-2"></span>Approve
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="{{ url('members/view/'.$user->id) }}" class="btn btn-danger" title="Block">
    ...
    <script>
        $(function () {
            $("#copywriterTable").DataTable({
                "language": {"zeroRecords": 'No Member'}
            });
        });
