                ...
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-4 m-auto text-white p-b-30">
                        <div class="text-md-right">
                            <a href="{{ route('projects.new') }}" class="btn btn-success"> <i class="mdi mdi-plus"></i> New Project</a>
...
{{--                                            <td>{{ $project->quality ? $project->category[$project->quality . '_min'] : $project->rate }}</td>--}}
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="{{ route('projects.view', ['project' => $project]) }}">
                                                    View</a></td>
                                        </tr>
                                    @empty
                                        <tr>
