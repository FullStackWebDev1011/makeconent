        ...
        <div class="invoice_preview invoice">
            ...
            <div class="vat" style="padding: 10px"><!-- Komunikat o tym, że faktura jest anulowana -->
                <div class="invoice_outline default">
                    <table class="clean to_half" style="margin-bottom: 1px">
                        <tr>
                            <td>
                                ...
                                <p>
                                    <strong>Data sprzedaży:</strong> {{ date('Y-m-d', strtotime($invoice->created_at))}}
                                </p>
                                <p>
                    ...
                    @php
                        $total = roundPrice($invoice->qty / (1 + config('settings.vat.pl')))
                    @endphp
                    @php
                        $fee = roundPrice($invoice->qty * config('settings.vat.pl'))
                    @endphp
                    @php
                        $sum = roundPrice($invoice->qty)
                    @endphp
                    <table class="clean split_half" style="border-top: 1px solid lightgray; width: 100%">
                        ...
                        <tr>
                            ...
                            <td id="buyer">
                                ...
                                <p>
                                    {{ $user->street }}, {{ $user->apartment_number }}<br>
                                    {{ $user->city }} {{ $user->post_code }}, Poland
                                </p>
                                @if($user->isCompany)
                                    <p>{{ $user->vat_number }}</p>
                                @endif
                    ...
                    <table class="main_inv_table VAT">
                        ...
                        <tr>
                            ...
                            <td class="row0 text_left name_col">
                                <span>
                                    Punkty pozwalające na zlecenie wykonania artykułów na platformie makeContent.pl
                                </span>
                            </td>
