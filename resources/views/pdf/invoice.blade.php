        ...
        <div class="invoice_preview invoice">
            ...
            <div class="vat" style="padding: 10px"><!-- Komunikat o tym, że faktura jest anulowana -->
                <div class="invoice_outline default">
                        ...
                        <tr>
                            <td>
                                ...
                                <p>
                                    ...
                                    Warszawa,
                                    {{ date('Y-m-d', strtotime($order->orderCreateDate))}}
                                </p>
                                <p>
                                    <strong>Data sprzedaży:</strong> {{ date('Y-m-d', strtotime($order->orderCreateDate))}}
                                </p>
                                <p>
                    ...
                    @php
                        $total = roundPrice((float)$order->totalAmount/123)
                    @endphp
                    @php
                        $fee = roundPrice((float)$order->totalAmount * 23 /12300)
                    @endphp
                    @php
                        $sum = roundPrice((float)$order->totalAmount/100)
                    @endphp
