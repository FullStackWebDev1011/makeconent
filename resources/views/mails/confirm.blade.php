...
@section('content')
    ...
    <div style="background-color:#EDF2F9;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
               style="background:#212841;background-color:#212841;width:100%;">
            <tbody>
            <tr>
                <td>
                    <!--[if mso | IE]>
                                ...
                                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0;text-align:center;vertical-align:top;">
                                    ...
                                    <div class="mj-column-per-100 outlook-group-fix"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="font-size:0px;padding:15px 0;word-break:break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:80px;"><a href="#"
                                                                    ...
                                                                    <img alt="" height="auto"
                                                                         src="https://atmos.atomui.com/default/assets/img/logo.png"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:600px;"><a href="#"
                                                                    ...
                                                                    <img alt="" height="auto"
                                                                         src="https://gallery.mailchimp.com/ef3bf10c922fc1ccc23d773aa/images/b4f61bc4-f3a0-4cec-bc63-fb3130debb42.jpg"
                                                                         style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;"
                                                                         width="600">
        ...
        <div style="background:#28304e;background-color:#28304e;Margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                   style="background:#28304e;background-color:#28304e;width:100%;">
                <tbody>
                <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#ffffff;">
                                            Hi {{ $user->getFullName() }}, Welcome Onboard !
                                        </div>
                                    </td>
                                </tr>
                            </table>
        ...
        <table
                align="center" border="0" cellpadding="0" cellspacing="0" class="body-section-outlook"
        ...
        <div class="body-section"
             style="-webkit-box-shadow: 0 25px 50px rgba(8,21,66,.06); -moz-box-shadow: 0 25px 50px rgba(8,21,66,.06); box-shadow: 0 25px 50px rgba(8,21,66,.06); Margin: 0px auto; max-width: 600px;">
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:32px;font-weight:light;line-height:24px;text-align:center;color:#637381;">
                                                                        <h1 style="line-height:1.3;font-size:32px;font-weight:100;margin-bottom:1px;">
                                                                            Please verfiy your email to activate
                                                                            account </h1>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" bgcolor="#00cc99"
                                                                                role="presentation"
                                                                                style="border:none;border-radius:3px;cursor:auto;padding:10px 25px;background:#00cc99;"
                                                                                valign="middle"><a
                                                                                        href="{{ $verifyUrl }}"
                                                                                        style="background:#00cc99;color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:17px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                                                                                        target="_blank">
                                                                                    Activate Account
                                                                                </a></td>
                                                                        </tr>
                                                ...
                                                <tr>
                                                    <td style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                        ...
                                                        <table
                                                                ...
                                                                cellspacing="0"
                                                                style="border-top:solid 1px #DFE3E8;font-size:1;margin:0px auto;width:520px;"
                                                                role="presentation" width="520px"
                                                        >
                                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                            You can visit following address for confirmation.
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            >
                                ...
                                >
                                    <tr>
                                        <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                        <![endif]-->
                        @include('mails.snippets.address')
                        <!--[if mso | IE]>
                        </td>
                        </tr>
                        </table>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:4px;">
                                                                                            <table border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                        <a href="https://twitter.com/home?status=https://mjml.io/"
                                                                                                           target="_blank">
                                                                                                            <img height="30"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center"
                                                                                ...
                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">
                                                                                    ...
                                                                                    you registered with AtomUI. (123
                                                                                    Main Street, Austin, TX 78701) and
                                                                                    agreed to receive emails from us
                                                                                    regarding new features, events and
                                                                                    special offers.
                                                                                </div>
                                                                            </td>
                                                                        </tr>
