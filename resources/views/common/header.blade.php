        ...
        <ul class="nav align-items-center">
                ...
                <div class="text-center">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn  btn-dark active">
                            ...
                            Balance: {{ Auth::user()->wallet ? roundPrice(Auth::user()->wallet->total_balance):'0,00' }} {{isset(auth()->user()->country)?auth()->user()->country->currency:''}}
                        </label>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item dropdown ">
                <a class="nav-link dropdown-toggle" href="#"   role="button" data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-sm avatar-online">
                        @if(Auth::user()->avatar)
                            <img src="{{asset(Auth::user()->avatar)}}" class="avatar-title rounded-circle" alt="{{ substr(Auth::user()->name, 0, 1)}}">
                        @else
                ...
                <div class="dropdown-menu  dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('profile') }}">  Profile / Rating
                    </a>
